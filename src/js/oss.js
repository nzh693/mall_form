...
const OSSConfig = {
    uploadHost: 'http://oss-cn-hangzhou.aliyuncs.com', //OSS上传地址
    type: 'scs',
    ossParams: {
        region: 'oss-cn-hangzhou',
        success_action_status: '200', // 默认200
        accessKeyId: 'LTAI4GC5r56UCqM8pfs3MPTK',
        accessKeySecret: 'aetrH5EM7oHv7KY81dNqamq9Kcyl9I',
        bucket: 'competion-file',
    },
}
